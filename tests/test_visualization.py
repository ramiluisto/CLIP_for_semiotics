...
class TestVisualization(unittest.TestCase):
    ...
    def test_plot_similarity_heatmap(self, mock_subplots):
        ...
        self.assertEqual(args[0].shape, (2, 2))  # 2 images, 2 prompts
    ...
    def test_create_map_with_images(self, mock_image, mock_marker, mock_map):
        ...
        with self.assertRaises(ValueError):
            create_map_with_images(
                [{"filepath": "image1.jpg", "gps_coordinates": None}]
            )

    @patch("src.visualization.plt.subplots")
    def test_plot_similarity_by_location(self, mock_subplots):
    ...
    @patch("src.visualization.Image")
    def test_display_image_grid(self, mock_image, mock_figure):
